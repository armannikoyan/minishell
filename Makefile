...
SRCS = main.c ft_utils.c \
       ...
       ft_tokendelone.c ft_report_error.c ft_space_correction_utils.c ft_space_correction_utils2.c \
       ...
       ft_syntax_tree_2.c ft_argment_quote_helper.c ft_execution_command2.c \
       ft_exec_helper.c ft_exec_redir_helper.c ft_exec_pipe_helper.c ) \
       $(addprefix bin/, \
