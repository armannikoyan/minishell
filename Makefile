...
INC = -Ireadline -I$(LIBFT_DIR) #-I/usr/local/Cellar/readline/8.2.13/include -I$(LIBFT_DIR)
LIBFT = $(LIBFT_DIR)/libft.a
RL_LIB = -lreadline -lncurses #-L/usr/local/Cellar/readline/8.2.13/lib -lreadline
