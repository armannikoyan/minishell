...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/27 02:09:37 by lvarnach          #+#    #+#             */
/*   Updated: 2026/01/27 02:11:39 by lvarnach         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// is a directory and has execute permission.
// All filesystem-related validation for the
// `cd` builtin is centralized here.
// Returns 0 on success, 1 on failure and prints
