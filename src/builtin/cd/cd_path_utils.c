...
// Checks whether the given path exists, is a directory and has execute
// permission. All filesystem-related validation for the `cd` builtin is
// centralized here. Returns 0 on success, 1 on failure and prints an
