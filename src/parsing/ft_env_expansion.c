...
/*   Updated: 2025/01/14 15:58:02 by gsimonia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_process_quotes(char *input, unsigned short *i, char *output, unsigned short *j)
{
...
char *ft_handle_dollar_sign(char *input, char *output, unsigned short *i, unsigned short *j)
{
    output[*j] = input[*i];
    (*i)++;
    (*j)++;
