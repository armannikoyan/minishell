...
/*   Updated: 2025/01/13 05:15:39 by anikoyan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/09 16:22:44 by gsimonia          #+#    #+#             */
/*   Updated: 2025/01/13 03:13:05 by anikoyan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_execute_pipe_child(t_node *node, char ***envp, int fd, int redirect_fd)
{
	dup2(fd, redirect_fd);
	close(fd);
